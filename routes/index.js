(function() {
  ...
  applicationScripts = ['/src/conf/configurationNode.js', '/javascripts/src/LSFileInput.js', '/javascripts/src/LSFileChooser.js', '/javascripts/src/LSErrorNotification.js', '/javascripts/src/AbstractFormController.js', '/javascripts/src/AbstractParserFormController.js', '/javascripts/src/BasicFileValidateAndSave.js', '/javascripts/src/PickList.js', '/javascripts/src/Label.js', '/javascripts/src/AnalysisGroup.js', '/javascripts/src/Experiment.js', '/javascripts/src/Protocol.js', '/javascripts/src/PrimaryScreenExperiment.js', '/javascripts/src/DoseResponseAnalysis.js', 'javascripts/src/CurveCurator.js', 'javascripts/src/CurveCuratorAppController.js', '/javascripts/src/ModuleMenus.js', '/javascripts/src/ModuleLauncher.js', '/javascripts/src/ModuleMenusConfiguration.js', '/javascripts/src/BatchListValidator.js', '/javascripts/src/DocUpload.js', '/javascripts/src/DocForBatches.js', '/javascripts/src/DocForBatchesConfiguration.js', '/javascripts/src/GenericDataParser.js', '/javascripts/src/FullPK.js', '/javascripts/src/MicroSol.js', '/javascripts/src/Pampa.js', '/javascripts/src/MetStab.js', '/javascripts/src/BulkLoadContainersFromSDF.js', '/javascripts/src/BulkLoadSampleTransfers.js', '/javascripts/src/PrimaryScreenExperiment.js'];
  ...
  exports.liveServiceSpecRunner = function(req, res) {
    ...
    global.specRunnerTestmode = false;
    jasmineScripts = ['src/lib/testLibraries/jasmine-jstd-adapter/jasmine/lib/jasmine-core/jasmine.js', 'src/lib/testLibraries/jasmine-jstd-adapter/jasmine/lib/jasmine-core/jasmine-html.js', 'src/lib/testLibraries/jasmine-jquery/lib/jasmine-jquery.js', 'src/lib/testLibraries/sinon.js'];
    specScripts = ['javascripts/spec/ProjectsServiceSpec.js', 'javascripts/spec/ProtocolServiceSpec.js', 'javascripts/spec/PreferredBatchIdServiceSpec.js', 'javascripts/spec/dnsAuthenticationServiceSpec.js', 'javascripts/spec/testFixtures/MicroSolTestJSON.js', 'javascripts/spec/MicroSolServiceSpec.js'];
    scriptsToLoad = requiredScripts.concat(jasmineScripts, specScripts);
    scriptsToLoad = scriptsToLoad.concat(applicationScripts);
