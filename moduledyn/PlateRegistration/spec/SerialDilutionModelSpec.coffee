...
describe "SerialDilutionModel", ->
  beforeEach ->
    ...
    @sdm.set SERIAL_DILUTION_MODEL_FIELDS.LOWEST_VOLUME_WELL, 5
    @sdm.set SERIAL_DILUTION_MODEL_FIELDS.ALL_WELLS_HAVE_VOLUME, true
    @sdm.set SERIAL_DILUTION_MODEL_FIELDS.ALL_WELLS_HAVE_CONCENTRATION, true
