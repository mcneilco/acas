...
) (if (typeof process is "undefined" or not process.versions) then window.baseEntityServiceTestJSON = window.baseEntityServiceTestJSON or {} else exports)
