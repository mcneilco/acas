...
) (if (typeof process is "undefined" or not process.versions) then window.componentBrowserServiceTestJSON = window.componentBrowserServiceTestJSON or {} else exports)
