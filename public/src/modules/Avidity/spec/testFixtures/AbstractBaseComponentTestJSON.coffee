((exports) ->
	...
	exports.baseComponentBatch =
		codeName: "BC000001-1"
		id: 11
		ignored: false
		lsKind: "base component" #should be same as the className
		lsStates: [
			comments: null
			id: 11
			ignored: false
			lsKind: "base component batch"
			lsTransaction: 1
			lsType: "metadata"
			lsTypeAndKind: "metadata_base component batch"
			lsValues: [
				clobValue: null
				codeValue: null
				comments: null
		...
		lsTransaction: 1
		lsType: "batch"
		lsTypeAndKind: "batch_base component"
		modifiedBy: null
		modifiedDate: null
		recordedBy: "jane"
...
) (if (typeof process is "undefined" or not process.versions) then window.baseComponentTestJSON = window.baseComponentTestJSON or {} else exports)
