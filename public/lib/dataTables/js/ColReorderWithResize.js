...
// Store the initial size of the table
                this.s.mouse.tableStart = $('.bv_advancedQueryContainer').width();
                ////////////////////
                //Martin Marchetta
...
// resize container along with column
                $('.bv_advancedQueryContainer').width(this.s.mouse.tableStart + moveLength);
