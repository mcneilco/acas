...
(function (port) {
    ...
    var path = require('path'),
        ...
        serve = function (req, res) {
            ...
            case 'GET':
                ...
                break;
            case 'POST':
            	options.tmpDir = options.tmpDir + "/" + req.params.filePath
            	options.uploadDir = options.uploadDir + "/" + req.params.filePath
                setNoCacheHeaders();
                handler.post();
                break;
            case 'DELETE':
    ...
    UploadHandler.prototype.post = function () {
        ...
        form.on('fileBegin', function (name, file) {
            ...
            fs.renameSync(file.path, options.uploadDir + '/blah/' + fileInfo.name);
