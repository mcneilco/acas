/*
This service parses data from the Pampa format and saves it to the database
...
(function() {
  ...
  goodDataRequest = {
    fileToParse: "public/src/modules/DNSPampa/spec/specFiles/2013yyy_usol_xxxxx.xls",
    inputParameters: window.PampaTestJSON.validPampa,
    dryRun: true,
    user: 'jmcneil',
    testMode: true
  };
  ...
  badDataRequest = {
    fileToParse: "public/src/modules/DNSPampa/spec/specFiles/2013yyy_usol_xxxxx_with_error.xls",
    inputParameters: window.PampaTestJSON.validPampa,
    dryRun: true,
    user: 'jmcneil',
    testMode: true
  ...
  describe('Pampa Parser Service testing', function() {
    beforeEach(function() {
