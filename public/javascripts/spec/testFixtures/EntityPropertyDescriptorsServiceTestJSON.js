(function() {
  (function(exports) {
    return exports.propertyDescriptors = {
      compound: {
        parent: [
          {
            'valueDescriptor': {
  ...
  })((typeof process === "undefined" || !process.versions ? window.entityDescriptorsTestJSON = window.entityPropertyDescriptorsTestJSON || {} : exports));
