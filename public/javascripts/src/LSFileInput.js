(function() {
  ...
  window.LSFileInputController = (function(superClass) {
    extend(LSFileInputController, superClass);

    function LSFileInputController() {
      return LSFileInputController.__super__.constructor.apply(this, arguments);
    }
