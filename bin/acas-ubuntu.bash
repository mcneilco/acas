...
case $1 in
    start)
        ...
        /usr/sbin/apache2 -f $ACAS_HOME/conf/compiled/apache.conf -k start
    ...
    stop)
        ...
        /usr/sbin/apache2 -f $ACAS_HOME/conf/compiled/apache.conf -k stop
    ...
    reload)
        ...
        /usr/sbin/apache2 -f $ACAS_HOME/conf/compiled/apache.conf -k graceful
