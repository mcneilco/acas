(function() {
  ...
  getApacheConfsString = function(config, apacheCompileOptions, apacheHardCodedConfigs, acasHome) {
    ...
    confs.push('MinSpareServers ' + _.findWhere(apacheHardCodedConfigs, {
      directive: 'MinSpareServers'
    }).value);
    confs.push('MaxSpareServers ' + _.findWhere(apacheHardCodedConfigs, {
      directive: 'MaxSpareServers'
    }).value);
    confs.push('ServerLimit ' + _.findWhere(apacheHardCodedConfigs, {
      directive: 'ServerLimit'
    }).value);
    confs.push('MaxClients ' + _.findWhere(apacheHardCodedConfigs, {
      directive: 'MaxClients'
    }).value);
    confs.push('MaxRequestsPerChild ' + _.findWhere(apacheHardCodedConfigs, {
