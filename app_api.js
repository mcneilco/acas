(function() {
  ...
  startApp = function() {
	...
	routeSet_3 = require("./routes/CationicBlockServiceRoutes.js");
	...
	routeSet_5 = require("./routes/ComponentsBrowserServiceRoutes.js");
	...
	routeSet_15 = require("./routes/InternalizationAgentServiceRoutes.js");
	if (routeSet_15.setupAPIRoutes) {
		routeSet_15.setupAPIRoutes(app); }
	routeSet_16 = require("./routes/LinkerSmallMoleculeServiceRoutes.js");
	...
	routeSet_23 = require("./routes/ProteinServiceRoutes.js");
	...
	routeSet_27 = require("./routes/SpacerServiceRoutes.js");
