(function() {
  ...
  startApp = function() {
	...
	routeSet_4 = require("./routes/ControllerRedirectRoutes.js");
	if (routeSet_4.setupAPIRoutes) {
		routeSet_4.setupAPIRoutes(app); }
	routeSet_5 = require("./routes/CurveCuratorRoutes.js");
