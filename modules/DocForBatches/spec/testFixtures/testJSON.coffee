((exports) ->
	...
	exports.batchNameList = [
		id: 11
		requestName: "CMPD-0000007-01"
		preferredName: "CMPD-0000007-01"
		comment: "good"
	,
		id: 12
		requestName: "CMPD_1111"
		preferredName: "CMPD_1112"
		comment: "ok"
	,
		id: 13
		requestName: "CMPD_1111"
		preferredName: "CMPD_1113"
		comment: "bad"
	]
	...
	exports.experiment =
		...
		version: 0
) (if typeof process is "undefined" or not process.versions then (window.testJSON = window.testJSON or {}) else exports)
