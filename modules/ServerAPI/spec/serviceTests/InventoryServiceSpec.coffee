...
inventoryServiceRoutes = require "#{acasHome}/routes/InventoryServiceRoutes.js"
...
if process.env.NODE_ENV == "integration"
	describe "Inventory Service testing", ->
		before (done) =>
			...
			inventoryServiceRoutes.getOrCreateContainers @definitionContainersRequest, (response) =>
				@definitionContainers = response
				done()
