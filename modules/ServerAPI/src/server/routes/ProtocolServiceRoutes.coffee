...
exports.getTemplateSELFile = (req, resp) ->
	...
	# TODO - this isn't showing up? Changes to this route arent applying? 
	console.log "getTemplateSELFile() hit"

	# OPTIONAL - would be nice to be able to fetch the protocol name and project, thereby only requiring the code to be sent
	# exports.protocolByCodenameInternal req.body.protocolCode, (json, statusCode) ->
	#	console.log "HIT!"
	#	resp.statusCode = statusCode
	#	resp.json json 
