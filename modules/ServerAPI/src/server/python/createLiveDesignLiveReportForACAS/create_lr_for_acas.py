...
def make_acas_live_report(api, compound_ids, assays_to_add, experiment_code, database, projectId, ldClientVersion):
...
#    	projectId = api.get_project_id_by_name(project)
    ...
    if type(projectId) is not int:
		projectId = 0
    lr_id = make_acas_live_report(api, compound_ids, assays_to_add, experiment_code, database, projectId, ld_client_version)
