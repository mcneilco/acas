...
sleep(0);
    ...
    header("Content-type: application/json;charset=utf-8");
//    echo '[{"corpName":"SGD-1234-Na","stereoCategoryName":"Racemic","stereoComment":"","lotIDs":{"SGD-1234-Na-1":1,"SGD-1234-Na-2":2,"SGD-1234-Na-3":3,"SGD-1234-Na-5":5},"molStructure":"CC[C@H](C)C(CCCCCCNC(C)(C)OC(=O)OC(=O)OC(C)(C)C)[C@@H](CC(=O)C1=C(C(C)C)C(CCC[C@@H](CC2=CC=CC=C2)C(=O)OC)=CC=C1)OC"},{"corpName":"SGD-1234-Cl","stereoCategoryName":"Racemic","stereoComment":"st comm","lotIDs":{"SGD-1234-Cl-1":1,"SGD-1234-Cl-2":2,"SGD-1234-Cl-3":3},"molStructure":"C1=CC2=CC3=CC4=CC5=CC6=C(C=CC=C6)C=C5C=C4C=C3C=C2C=C1 |c:0,12,14,17,20,23,26,29,t:2,4,6,8,10|"},{"corpName":"SGD-1234-C14","stereoCategoryName":"Scalemic","stereoComment":"","lotIDs":{"SGD-1234-C14-1":1,"SGD-1234-C14-2":2},"molStructure":"N1C=CC2=C1NC1=C2C2=C(N1)NC1=C2C2=C(NC=C2)N1 |c:1,3,7,15,21,t:18|"},{"corpName":"SGD-2222-K","stereoCategoryName":"See Comment","stereoComment":"lots of centers","lotIDs":{"SGD-2222-K-1":1},"molStructure":"C1CC2CC3CC4CC5C(CC6CC7CC8CCCC8C7C56)C4C3C2C1"}]';
sleep(0);
